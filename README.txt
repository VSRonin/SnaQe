...
This is a version of the classical snake game built using Qt libraries.
...
You can download the qt libraries, needed to build the program, from http://qt.nokia.com
